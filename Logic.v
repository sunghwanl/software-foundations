...
Fact not_implies_our_not : forall (P:Prop),
  ~ P -> (forall (Q:Prop), P -> Q).
Proof.
  unfold not. intros P H Q.
  assert (H': False -> Q).
  { apply ex_falso_quodlibet. }
  intro H''. apply H in H''. apply H' in H''. apply H''.
Qed.
(** [] *)
...
Proof.
  ...
  split.
  - intros H. apply pq in H. apply qr in H. apply H.
  - intros H. apply rq in H. apply qp in H. apply H.
Qed.
(** [] *)
...
Proof.
  intros X P H. intros [x Hx]. unfold not in Hx.
  apply Hx. apply H.
Qed.  
(** [] *)
...
Proof.
  ...
  - induction l as [| x' l' IH].
    + simpl. intros t H f. inversion f.
    + simpl. intros [H1 H2].
      intros x [H3 | H4].
      * rewrite <- H3. apply H1.
...
Proof.
  intros Podd Peven n.
  intros H1 H2. unfold combine_odd_even in H1.
...
Proof.
  ...
  - reflexivity.
  - simpl. rewrite -> IH with ([x1]).
    intros l2. rewrite <- app_assoc.
    simpl. apply IH.
Qed.
...
Proof.
  ...
  - rewrite -> evenb_S.
    ...
    + simpl. inversion IH.
      exists (S x). rewrite -> H. reflexivity.
Qed.
(** [] *)
...
Proof.
  split.
  - destruct b1 as [].
    + simpl. intro H. left. apply H.
    + simpl. intro H. right. apply H.
  - intros [H1 | H2].
    + rewrite -> H1. reflexivity.
    + rewrite -> H2. destruct b1 as [].
      * reflexivity.
      * reflexivity.
Qed.
(** [] *)
  ...
  - destruct y as [| y'].
    + simpl. split.
      ...
      * intros contra.
        ...
        inversion H.
    + simpl. split.
      * intros H contra. inversion contra.
      * reflexivity.
  - destruct y as [| y'].
    + simpl. split.
      * intros H contra. inversion contra.
...
Proof.
  ...
  - destruct l2 as [| a2 l2'].
    + simpl. split.
      ...
      * intros contra. inversion contra.
    + simpl. split.
      * intros H1. apply andb_true_iff in H1.
        destruct H1 as [HP HQ].
        apply H in HP.
        apply IH in HQ.
        rewrite -> HP. rewrite -> HQ.
        reflexivity.
      * intros H1. rewrite -> andb_true_iff.
        { split.
          - apply H. inversion H1. reflexivity.
          - apply IH. inversion H1. reflexivity. }
Qed.
(** [] *)
...
Proof.
  ...
  - induction l as [| x l' IH].
    ...
    + simpl. intros H.
      ...
      split.
      * apply H0.
      * apply IH in H1. apply H1.
  - induction l as [| x l' IH].
    + simpl. reflexivity.
    + simpl. intros [H0 H1].
      rewrite -> H0.
      apply IH in H1. rewrite -> H1.
      reflexivity.
Qed.
...
Theorem excluded_middle_irrefutable:  forall (P:Prop),
  ~ ~ (P \/ ~ P).
Proof.
  intros P. intros H. unfold not in H.
  apply H. right. intro. apply H. left. apply H0.
Qed.
(** [] *)
...
Proof.
  ...
  destruct EM with (P).
  - apply H0.
  - apply H. intros H1. unfold not in H0.
    apply H0 in H1. inversion H1.
Qed.

Theorem peirce_to_double_neg :
...
Proof.
  ...
  unfold not.
  intros H.
  apply PR with (Q:=False).
  intros H0.
  apply H in H0.
  inversion H0.
Qed.

Theorem double_neg_to_de_morgan :
...
Proof.
  ...
  apply H1.
  intros H3.
  apply H in H3. apply H2 in H3. apply H3.
Qed.  
