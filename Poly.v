...
Theorem map_app : forall (X Y : Type) (f : X -> Y) (l : list X) (x : X),
...
Proof.
  intros. induction l as [| x l' IH].
  - reflexivity.
  - simpl. rewrite <- IH. unfold fold_map.
    simpl. reflexivity.
Qed.
(** [] *)
...
Theorem nth_theorem : forall (X: Type) (l: list X) (n: nat),
